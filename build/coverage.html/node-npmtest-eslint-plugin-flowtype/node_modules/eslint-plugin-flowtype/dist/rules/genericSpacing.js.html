...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-eslint-plugin-flowtype/node_modules/eslint-plugin-flowtype/dist/rules/genericSpacing.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-eslint-plugin-flowtype/node_modules/eslint-plugin-flowtype/dist/rules/genericSpacing.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-eslint-plugin-flowtype/node_modules/eslint-plugin-flowtype/dist/rules/</a> &#187; genericSpacing.js</div>
</div>
<div class="body">
...
&nbsp;
<span class="cstat-no" title="statement not covered" >  var never = (context.options[0] || 'never') === 'never';</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  return {</span>
    GenericTypeAnnotation<span class="fstat-no" title="function not covered" >(node) {</span>
<span class="cstat-no" title="statement not covered" >      var types = node.typeParameters;</span>
&nbsp;
      // Promise&lt;foo&gt;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >      var _sourceCode$getFirstT = sourceCode.getFirstTokens(types, 2),</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >      var _sourceCode$getLastTo = sourceCode.getLastTokens(types, 2),</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >      var spacesBefore = firstInnerToken.start - opener.end;</span>
<span class="cstat-no" title="statement not covered" >      var spacesAfter = closer.start - lastInnerToken.end;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      if (never) {</span>
<span class="cstat-no" title="statement not covered" >        if (spacesBefore) {</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (spacesAfter) {</span>
<span class="cstat-no" title="statement not covered" >          context.report({</span>
            data: { name: node.id.name },
...
<span class="cstat-no" title="statement not covered" >        if (spacesBefore &gt; 1) {</span>
<span class="cstat-no" title="statement not covered" >          context.report({</span>
            data: { name: node.id.name },
        ...
        } else <span class="cstat-no" title="statement not covered" >if (spacesBefore === 0) {</span>
<span class="cstat-no" title="statement not covered" >          context.report({</span>
            data: { name: node.id.name },
...
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (spacesAfter &gt; 1) {</span>
<span class="cstat-no" title="statement not covered" >          context.report({</span>
            data: { name: node.id.name },
        ...
        } else <span class="cstat-no" title="statement not covered" >if (spacesAfter === 0) {</span>
<span class="cstat-no" title="statement not covered" >          context.report({</span>
            data: { name: node.id.name },
